...
{
    private function workflowFor(Task $task): WorkflowInterface
    {
        return self::getContainer()->get(Registry::class)->get($task, $task->getType()->workflowName());
    }
    ...
    public function testDeliverableProgressTransitions(): void
    {
        ...
        $workflow = $this->workflowFor($task);
