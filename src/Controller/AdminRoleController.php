 ...
 * {@see Role::setLevel()}. Every action demands write access to the {@see Area::ADMINISTRATION} area
 * (via the {@see AreaVoter}), so Direction can manage roles without holding the superuser admin flag.
 */
#[Route('/admin/roles')]
